...
This was apparently the problem with the code. Why nickels and dimes were returning "0" was because I only set the condition to "greater than", not "greater than or equal to", which means for example, if I input 10, the code would return 0 because it's not greater than 10. 😐
